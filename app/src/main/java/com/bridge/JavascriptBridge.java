...
public class JavascriptBridge {
    ...
    class JavascriptInterface{
        ...
        public String getCommands(){
            ArrayList<Command> temp = jsCommandQueue;
            jsCommandQueue = new ArrayList<Command>();
        ...
        public void setResult(long serial, String jsonResult){
            Command command = jsCommandMap.remove(serial);
            if(command == null){
                return;
            }
            ...
            if(command.callback != null && jsonResult != null && !jsonResult.isEmpty()){
                ...
                command.callback.onComplete(json, command.cmd, command.params);
            }
            command.release();
        }
        /**
         ...
         */
        @android.webkit.JavascriptInterface
        public String require(String method, String params){
            Function function = javaMethodMap.get(method);
            if(function != null){
                try {
    ...
    private HashMap<Long, Command> jsCommandMap;
    
    private ArrayList<Command> jsCommandQueue;
    ...
    public JavascriptBridge(WebView mWebView) {
        jsCommandMap = new HashMap<Long, Command>();
        jsCommandQueue = new ArrayList<Command>();
    ...
    public void require(String cmd, Bundle params, Callback callback){
        ...
        jsCommandMap.put(command.serial, command);
